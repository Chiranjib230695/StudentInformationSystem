...
<div id="mySidenav" class="sidenav">
  ...
  <a class="active" href="viewalumni.php">Alumni</a>
...
if(isset($_POST["submit"]))
{
	...
	$sql="select * from alumni where name like '$key_word%'";	

}
		else
		{
			$sql="Select * from alumni order by batch desc";
		}
		...
		while($row=mysql_fetch_array($result))
		{
			...
			echo '<td align="center"><a href="#.php?dc='.$row["id"].'" class="button editbutton"><img src="image/edit.png" width="15" height="15"  alt=""/></a>&nbsp;<a href="deletealumni.php?id='.$row["id"].'" class="button delbutton" onClick="return condel();"><img src="image/delete.png" width="15" height="15"  alt=""/></a></td>';
			echo '</tr>';
		}
