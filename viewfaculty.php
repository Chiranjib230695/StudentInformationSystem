...
<div id="mySidenav" class="sidenav">
  ...
  <a class="active" href="viewfaculty.php">Faculty</a>
...
<table width="80%" cellpadding="0" cellspacing="0" border="0">
  <thead>
   <tr>
     ...
     <th width="200" class="col"style="color:#0FF"><font size="5">Designation</font></th>
...
if(isset($_POST["submit"]))
{
	...
	$sql="select * from faculty where name like '$key_word%'";	
		...
		while($row=mysql_fetch_array($result))
		{
			...
			echo '<td align="center"><a href="#.php?dc='.$row["name"].'" class="button editbutton"><img src="image/edit.png" width="15" height="15"  alt=""/></a>&nbsp;<a href="deletefaculty.php?id='.$row["name"].'" class="button delbutton" onClick="return condel();"><img src="image/delete.png" width="15" height="15"  alt=""/></a></td>';
			echo '</tr>';
		}
