...
<ul>
  ...
  <li><a href="#" class="active">Insert Master Marks</a></li>
    ...
    <tr>
      <td width="100%"><table width="885" border="0" align="center">
        ...
        <tr>
          ...
          <td>Semester</td>
          <td>:</td>
          <td><input name="sem" type="text" required id="sem" value="6th Semester" readonly="readonly"></td>
        </tr>
    </table></td>
    </tr>
  </table>
...
<table width="50%" border="0" align="center">
  ...
  <tr>
    <td colspan="3"><div align="right">
      <input name="submit" type="submit" class="button5" id="submit" form="form1" formaction="markssave6sem.php" value="Submit">
    </div></td>
