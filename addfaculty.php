...
<ul>
  ...
  <li><a href="addfaculty.php" class="active">Add Faculty</a></li>
...
<div id="main"><span style="font-size:30px;cursor:pointer" onclick="openNav()"><font style="color:#FFF">&#9776;</font></span>
  <form method="post" enctype="multipart/form-data" name="form1" id="form1">
    <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p style="text-align: center; font-size: 26px; font-style: normal; font-weight: bold;">Faculty Details</p>
    ...
    <tr>
      <td><table width="100%" border="0" align="center">
        <tr>
          ...
          <td width="12">:</td>
          <td width="373"><input name="name" type="text" required id="name"></td>
          <td width="78">&nbsp;</td>
          <td width="321"><div id="preview"></div>
  </td>
        </tr>
        <tr>
          <td>Designation</td>
          <td>:</td>
          <td><input name="designation" type="text" required id="designation" style="text-transform: capitalize;"></td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>Address</td>
          <td>:</td>
          <td><input name="address" type="text" required id="address" style="text-transform: capitalize;"></td>
          <td>&nbsp;</td>
          </tr>
        <tr>
          <td>Blood Group</td>
          ...
          <td>&nbsp;</td>
          <td><input name="fileField" type="file" required class="btn0" id="fileField" onChange="loadFile(event)" accept="image/*"></td>
        </tr>
        <tr>
          <td>Qualification</td>
          <td>:</td>
          <td><input name="qualification" type="text" required id="qualification" style="text-transform: capitalize;"></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
  ...
  <table width="24%" border="0" align="center">
    <tr>
      <td align="center"><input name="submit" type="submit" class="button5" id="submit" formaction="addfacultysave.php" value="     Submit    "></td>
